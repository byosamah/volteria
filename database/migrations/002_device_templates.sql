-- ============================================
-- Solar Diesel Hybrid Controller - Device Templates
-- Migration: 002_device_templates
--
-- This inserts the initial device templates.
...
-- ComAp InteliGen 500
-- Note: Register addresses are placeholders - need actual ComAp documentation
INSERT INTO device_templates (
    template_id,
    name,
    device_type,
...
INSERT INTO device_templates (
    ...
    FALSE  -- Inactive until registers are defined
...
-- SELECT template_id, name, device_type, rated_power_kw, is_active FROM device_templates ORDER BY device_type, name;
