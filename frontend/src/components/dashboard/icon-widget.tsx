    ...
    >
      ...
      {imageUrl && (
        <div
          className="absolute"
          style={{
            top: (isCustomImage || useContainSize) ? 4 : 10,
            bottom: hasBottomContent ? ((isCustomImage || useContainSize) ? 36 : 36) : 4,
            left: (isCustomImage || useContainSize) ? 4 : 2,
            right: (isCustomImage || useContainSize) ? 4 : 2,
