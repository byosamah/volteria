 ...
 *
 * Both call backend which uses service_role to bypass RLS.
 */
...
export async function PATCH(
  ...
  try {
    ...
    // Call backend to update site (uses service_role to bypass RLS)
    ...
    if (!backendResponse.ok) {
      ...
      console.error("Backend site update failed:", errorText);
      return NextResponse.json(
        { error: errorText || "Failed to update site" },
